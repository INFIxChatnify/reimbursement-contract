...
import "./optimized/ProjectFactoryOptimized.sol";
 ...
 */
contract ProjectFactoryV3 is ProjectFactoryOptimized {
    constructor(
        address _projectImplementation,
        address _omthbToken,
        address _metaTxForwarder,
        address _admin
    ) ProjectFactoryOptimized(_projectImplementation, _omthbToken, _admin) {
