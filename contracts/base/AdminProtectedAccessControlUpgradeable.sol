...
/**
 * @title AdminProtectedAccessControlUpgradeable
 * @notice Upgradeable version of AdminProtectedAccessControl
 * @dev Prevents removal of the last admin and tracks admin count using EnumerableSet
 */
abstract contract AdminProtectedAccessControlUpgradeable is AccessControlUpgradeable {
